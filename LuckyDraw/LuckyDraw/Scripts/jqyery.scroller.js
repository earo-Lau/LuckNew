...
scrollVertical.prototype.play = function(o){
	...
	var anim = function(){
		...
		if (o.isMoz) { // Mozilla引擎浏览器
			...
			s_msg.style.top = - o.scrollValue + "px";
			c_msg.style.top = (msg_h-o.scrollHeight) + "px";
		}
...
function scrollVertical(disp, msg, tg){
	...
	this.unitHeight = s_msg.getElementsByTagName(tg).length>0? s_msg.getElementsByTagName(tg)[0].offsetHeight:0;
	// 获取整个信息框的高度
